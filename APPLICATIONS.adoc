...
|
General Porpuse Text-Editor with

* a nice GUI,
* a great and big Plugin-System,
* Auto-Caching of unsaved Files (like in Notepad++) and
* available for any OS (Program build using https://electronjs.org/[Electron(js)])
...
* an overwhelming Amount of Features (e.G: Automatic-Generation of
Getters/Setters/Constructors/toString/..., Bytecode-Previewer, awesome
Debugger, built-in decompiler, Grails support,
Complete-Text-Search, awesome working Renamer/Searcher of Files and
even Literals - which finds all right occurences, even in comments or
strings) and
