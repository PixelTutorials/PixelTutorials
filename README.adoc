...
* I don't limit myself to knowing only part of it. If I would need to define my keen interest area, it would be https://roadmap.sh/backend[Dev] - https://roadmap.sh/devops[Ops].
+
I could talk for hours about my enthusiasm for Web Development, especially about the concepts of the Browser and its accompanying protocols/specifications and the prospects they still offer and continue to enable us today.
