...
One may have to dig very deep and jump over promises upon sales talk upon buzzwords to figure out what all the new software and things actually (mostly just only) do at the principled level, but the important thing is that it is still possible.
