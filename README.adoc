...
I know my way around Linux, Windows, IT, Programming and also try to grasp an understanding about most other things as well.

There's a lot of patterns and software involved in today's IT world.
My primary drivng force is that one shall not forget that https://blog.nelhage.com/post/computers-can-be-understood/[*Computers are not magic, and Software _can_ be understood*].
I especially like to get behind the concept of things first when learning them - 
reason being there's too much (aaS) software these days that just uses buzzwords upon buzzwords upon nice overly vague descriptions, 
which leads to one really needing to dig very deep to find out what they actually (mostly "just") do
and if they're worth the added layer and security implications and what not.
...
__In other words__, I https://www.stilldrinking.org/programming-sucks[thankfully] can and do still live in and with this dream world ;).
