...
_It's all still just some sand that we tricked into doing things through the use of electricity passing through a complex pattern of logic gates ;)_
...
__In other words__, I https://www.stilldrinking.org/programming-sucks[thankfully] can and do still live in and with this dream world ✌️.
// because of my lack in experience working on more real projects with more real people in a more real/defined field ✌️.
