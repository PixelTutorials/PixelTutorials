...
I know my way around Linux, Windows, IT, Programming and most of the other things as well.

I like to get behind the concept of things
(https://blog.nelhage.com/post/computers-can-be-understood/[*Computers are not magic; Software can be understood*])
// in fact, nothing is magic. it's all just concepts
and understand what they're _actually_ for.
...
Programming, Linux, Planning things, Cooking, Light Sports, Watching Movies with Friends
